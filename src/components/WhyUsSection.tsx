...
export default function WhyUsSection() {
  return (
    <section className="py-32 bg-helix-blue-dark relative overflow-hidden">
      <div className="orb w-[600px] h-[600px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
        style={{ background: 'rgba(131,231,238,0.04)', position: 'absolute', borderRadius: '50%', filter: 'blur(100px)' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[3.4rem] font-bold text-white mb-7 leading-[1.1]" >
              Why Leaders <br />
            ...
            <div className="flex items-center gap-5 p-5 rounded-2xl glass-morphism border border-white/6">
              <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0"
                style={{ background: 'rgba(131,231,238,0.15)' }}>
                <ShieldCheck className="text-ph-purple-light" size={22} />
              </div>
              <div>
                <h4 className="text-white font-semibold text-sm mb-0.5" >98% Retention Rate</h4>
            ...
            {features.map((f, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5 group-hover:scale-105 transition-transform duration-400"
                  style={{ background: 'rgba(131,231,238,0.1)', border: '1px solid rgba(131,231,238,0.15)' }}>
                  {f.icon}
                </div>
                <h3 className="font-bold text-white text-base mb-2.5" >{f.title}</h3>
